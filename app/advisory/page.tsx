    ...
    return (
        <div className="bg-[#fdfdfd] min-h-screen">
            <div className="space-y-12 py-12 px-6 max-w-7xl mx-auto">
                {/* Premium Header */}
                <div className="bg-pesa-green rounded-[3rem] p-16 text-white shadow-2xl relative overflow-hidden border-b-8 border-pesa-gold text-center animate-in fade-in slide-in-from-top-10 duration-1000">
                    ...
                    <div className="relative z-10 space-y-6">
                        ...
                        <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-none">Our <span className="text-pesa-gold">Advisory</span></h1>
                        <p className="text-xl md:text-2xl text-white/70 font-medium max-w-3xl mx-auto leading-relaxed">
                            Bespoke consultancy for land developers, diaspora investors, and institutions seeking strategic real estate intelligence in Kenya.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    {/* Lead Form / Contact */}
                    <div className="bg-pesa-green p-12 rounded-[3.5rem] text-white flex flex-col justify-center relative overflow-hidden group border-b-[12px] border-pesa-gold">
                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <Button
                                    ...
                                    className="w-full h-16 bg-pesa-gold text-black font-black rounded-2xl text-xl shadow-2xl hover:scale-[1.05] transition-transform"
                                >
                                    Contact Consultant
                                </Button>
                            </div>
